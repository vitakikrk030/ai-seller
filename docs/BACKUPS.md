...
Before every meaningful change or server deploy:

- create a local backup if local files are edited;
- create a server backup if `/root/sai` is changed;
- record exact paths here.
...
- `/root/sai_backups/sai_before-trunk-clean-20260510-131451.tgz`
- `/root/sai_backups/sai_before-trunk-clean-20260510-131451`
...
- `/Users/alishereshbekov/Desktop/Новая папка 10/Новая папка 5/backups/passport-foundation-20260510-141910.tgz`
- `/Users/alishereshbekov/Desktop/Новая папка 10/before-bare-magistral-local-20260510-130951.tgz`
